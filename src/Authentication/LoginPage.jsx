...
const LoginPage = () => {
    ...
    return (
        <div className='login-page w-100 vh-100 d-flex flex-column text-center justify-content-center align-items-center' style={{ backgroundImage: "url('images/login-bg.png')" }}>
            <img src='images/logo.png' alt='StarFlix Logo' width='220px' />
            <div className='my-5'>
